...
def payment_succsess(request):
    return render(request, 'payment/payment_succsess.html', {})
...
def confirm_order(request):
    if request.POST:
        ...
        return render(request, 'payment/confirm_order.html', {'cart_products':cart_products, 'quantities':quantities, 'total':total, 'shipping_info':user_shipping})  #user_shipping
